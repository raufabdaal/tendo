...
import { applyP6SocialHeavyV4 } from "@/lib/p6-v4-heavy-lessons";
...
export const P6_SOCIAL_TOPICS: Topic[] = balanceTopicAnswers(applyP6SocialHeavyV4(addUpperPrimarySocialV4(P6_SOCIAL_TOPICS_DATA, "P6", P6_SOCIAL_TERMS)));
