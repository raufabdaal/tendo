...
import { applyP6EnglishHeavyV4 } from "@/lib/p6-v4-heavy-lessons";
...
const P6_ENGLISH_TERMS: Record<string, "Term I" | "Term II" | "Term III"> = {
  "p6-safety-road": "Term I",
  "p6-debating": "Term I",
  "p6-family-relationships": "Term II",
  "p6-occupations-crafts": "Term II",
  "p6-hotel-dining": "Term III"
};

const P6_ENGLISH_TOPICS_DATA: Topic[] = [
  {
    id: "p6-safety-road",
...
export const P6_ENGLISH_TOPICS: Topic[] = balanceTopicAnswers(applyP6EnglishHeavyV4(addUpperPrimaryEnglishV4(P6_ENGLISH_TOPICS_DATA, "P6", P6_ENGLISH_TERMS)));
