...
*Updated: 2026-07-15 · P7 SST structure split fixed; curriculum-intelligence pilot next**
...
Founder has locked a stricter content-formatting workflow for the current P7 Social Studies pass. The founder provides exact educational/source-traceable content; the agent restructures it into digestible modules with an inline check for each module. Topics 1–4 of P7 Social Studies are now strict-formatted across official subtopics and application/practice subtopics. Topic 4 `Vegetation of Africa` now covers `vegetation-types`, `factors-vegetation`, `importance-vegetation`, `game-parks-animals`, `population-vegetation` and `premium-vegetation-application`. Two structural errors have now been fixed: People of Africa subtopics were removed from Vegetation and restored under `people-ethnic-groups-settlement`; later Topic 7–10 subtopics were also removed from `foreign-influence-africa` and restored under their official topic objects (`nationalism-road-independence`, `post-independence-africa`, `economic-developments-africa`, `major-world-organisations`). Build passed with 413 static pages. Next active work is Topic 5: `people-ethnic-groups-settlement`, using the new curriculum-intelligence/source-traceability plan before writing or restructuring new content.


### Curriculum intelligence system started — 2026-07-15
A new source-traceable content pipeline has been started to break the cycle of unfinished or weakly sourced content. The master spec is `docs/spec/curriculum-intelligence-system-v1.md`. The first pilot is P7 Social Studies Topic 5, `people-ethnic-groups-settlement`. New pilot files live under `content/curriculum-intelligence/p7-sst/`, including a source registry, manifest, evidence-note scaffold and QA checklist. A structure audit script now exists at `scripts/audit-curriculum-intelligence.js`; first run passed with 0 failures and 26 warnings. The warnings are now useful backlog: Topic 5 needs verified evidence notes, and later P7 SST topics need inline-check completion. No new Topic 5 rewrite should be published until evidence notes and QA gates are ready.


### Topic 1 restart under curriculum intelligence — 2026-07-15
Founder flagged that Topic 1 `location-of-africa` still feels incomplete/misaligned and has over-spaced one-line strict fragments. Topic 1 has now been restarted under the curriculum-intelligence workflow. Evidence was extracted from NCDC P7 Set One PDF pages 315–317 / printed pages 294–296 into `content/curriculum-intelligence/p7-sst/topic-01-location-of-africa/evidence-notes.json`. A rewrite blueprint and QA checklist were also created. Current finding: the broad app structure is correct, but several modules need source justification or removal/quarantine, including longitude-time calculation, marine gateways/channels, and uses/advantages/disadvantages filler around continents/regions/capitals. The official NCDC pages require countries/capitals and African islands but do not provide the full lists. A candidate reference pack now exists at `content/curriculum-intelligence/p7-sst/topic-01-location-of-africa/reference-countries-capitals-islands.json`, using NCDC region names plus UN M49/Britannica/current capital cross-check logic, but it is not learner-approved until review issues are settled. Topic 1 `location-of-africa` learner-flow rewrite is now complete across all official subtopics and the application practice subtopic under the curriculum-intelligence workflow. Subtopic 5 `countries-capitals-africa` uses the approved shorter P7 school-first approach in the learner flow, while the full countries/capitals/islands reference pack remains support material. Unsupported longitude-time calculation, continent uses/advantages filler, marine-gateway/channel content, broad region uses/importance filler, and country/capital uses/landlocked-coastal filler have been removed from the core Topic 1 flow pending source/extension decisions. Latest curriculum-intelligence audit: 0 failures / 28 warnings. Next: review Topic 1 readability/spacing on device, then decide whether to start Topic 2 source-intelligence audit.


### Topic 2 source-intelligence audit started — 2026-07-15
After Topic 1 learner-flow rewrite, P7 SST Topic 2 `physical-features-of-africa` has been started under the same curriculum-intelligence direction. New evidence, blueprint and QA files live under `content/curriculum-intelligence/p7-sst/topic-02-physical-features-of-africa/`. Topic 2 `physical-features-of-africa` learner-flow rewrite is now complete across all subtopics under the curriculum-intelligence workflow. The rewrite focuses on relief/drainage, NCDC-listed features, map practice, formation processes, diagrams/models and value answers. Formation now prioritises folded, fault-block and volcanic mountains because NCDC guidance explicitly names them. Country/river-mouth/lake-location/relief-location examples and formation diagrams still need atlas/teacher review before premium-final status. Latest curriculum-intelligence audit: 0 failures / 34 warnings.


### Topic 3 source-intelligence audit started — 2026-07-15
P7 SST Topic 3 `climate-of-africa` has started under the curriculum-intelligence workflow. New evidence, blueprint and QA files live under `content/curriculum-intelligence/p7-sst/topic-03-climate-of-africa/`. Topic 3 `climate-of-africa` learner-flow rewrite is now complete across all subtopics under the curriculum-intelligence workflow. The rewrite keeps climate region names separate from characteristics, keeps the NCDC factor list exact, uses the NCDC human activity list by climate type, separates harmful human activities/effects/protection, removes mechanical uses/advantages filler, and marks country/climate examples for atlas/teacher review before premium-final status. Latest curriculum-intelligence audit: 0 failures / 40 warnings.


### Topic 4 source-intelligence audit started — 2026-07-15
P7 SST Topic 4 `vegetation-of-africa` has started under the curriculum-intelligence workflow. New evidence, blueprint and QA files live under `content/curriculum-intelligence/p7-sst/topic-04-vegetation-of-africa/`. Topic 4 `vegetation-of-africa` learner-flow rewrite is now complete across all subtopics under the curriculum-intelligence workflow. The rewrite keeps the NCDC vegetation type and factor lists exact, explains factor influence, separates importance to people from importance to animals/environment, aligns game parks/animal-zone content to NCDC requirements, and separates population distribution/reasons/effects/protection. Mechanical uses/advantages filler has been removed. Latest curriculum-intelligence audit: 0 failures / 46 warnings.


### Topic 5 source-intelligence audit started — 2026-07-15
P7 SST Topic 5 `people-ethnic-groups-settlement` has started under the curriculum-intelligence workflow. Official PDF pages 333–336 / printed pages 312–315 were extracted into evidence notes. Because the source includes older/sensitive ethnic terminology, Topic 5 has a critical sensitivity gate: learner-facing content must use respectful language, emphasise unity in diversity and avoid stereotyping. The first two subtopics, `origin-ethnic-groups` and `movements-ethnic-groups`, have been rewritten from source-backed blueprints. Latest curriculum-intelligence audit: 0 failures / 46 warnings.
